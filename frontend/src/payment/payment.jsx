...
const CheckoutForm = ({onClose}) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-[900px] h-[400px] mx-auto p-6 bg-white shadow-md rounded-lg">
      <input
        type="email"
        placeholder="Email"
        value={email}
      ...
      <p className='text-red-600 font-bold flex justify-end text-[22px] mt-6'>سعر إعلان اليوم الواحد : 450 $</p>
      {succeeded && <p className="text-green-500 mt-4">Payment succeeded!</p>}
    </form>
  );
};
